 ...
 */
public class PersonalTaxAdapter extends BaseAdapter {

    private Context mContext;
    private List<HashMap<String, String>> mList;

    public PersonalTaxAdapter(Context mContext, List<HashMap<String, String>> mapList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_personaltax, null);
