...
public class EaseChatFragment extends EaseBaseFragment implements EMEventListener {
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) { // 单聊
            ...
            titleBar.setRightImageRightResource(R.drawable.ease_mm_title_remove);
        } else {
            titleBar.setRightImageRightResource(R.drawable.ease_to_group_details_normal);
        ...
        titleBar.setRightImageRightClickListener(new OnClickListener() {
